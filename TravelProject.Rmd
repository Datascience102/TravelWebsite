...
source("1.Library/Library.R")
source("1.Library/allPublicLibraries.R")
source("1.Library/heatmapOutput.R")
source("1.Library/helpersSet1.R")
source("1.Library/helpersSet2.R")
source("1.Library/MatrixOperations.R")
...
```{r}
library("psych")
UnRotated_Results<-principal(num_data, nfactors=ncol(num_data), rotate="none",score=TRUE)
...
library("psych")
Variance_Explained_Table_results<-pca(num_data, graph=FALSE)
